    ...
    <nav>
        ...
        <ul class="show-desktop hide-mobile" id="nav">
            ...
            if (isset($_SESSION['email'])) {
                ...
                ?> <?php
                echo '<li><a href="login.php" class="<?php if($last_dir === "login.php") echo "active"; ?><i class="fas fa-user"></i> Login</a></li>';
            }
            ?> <li><a href="shopCart.php"><i class="fas fa-shopping-cart"></i> Shop Cart (<?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?>)</a></li> <?php
